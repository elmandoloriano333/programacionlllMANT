...
namespace ClienteSincrono
{
    class ClienteSincrono
    {
        ...
        public string lista(string titulodellibro, String autor, string editorial, int estadodellibro)
        {
            string cadena = titulodellibro + autor.ToString() + "," + editorial.ToString() + "," + estadodellibro.ToString();
